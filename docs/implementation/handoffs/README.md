...
- proteção operacional: o workspace agora possui Git (3 commits: baseline, guard de push destrutivo, fix de segurança do uuid), mas `p0/` e `benchmark_fixture/P0_ALIGNMENT.md` ainda estão untracked — crie snapshot/commit antes da primeira edição por modelo;
